...
class PortMonitor(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.link_costs = {}
        self.bw_limit = get_bw_limit('/home/tin/SDN_PyQt5/topo_mininet/thu.json')
