...
class MyTopo(Topo):
	def build(self, **param):
		...
		self.addLink(S8, S9, 2, 3, bw=100, delay='70ms', loss=0)
		self.addLink(S10, S11, 3, 2, bw=100, delay='20ms', loss=0)
		self.addLink(S3, S10, 3, 4, bw=100, delay='30ms', loss=0)
		self.addLink(S9, S6, 4, 3, bw=100, delay='40ms', loss=0)
		self.addLink(S8, S10, 3, 5, bw=100, delay='60ms', loss=0)
		self.addLink(S9, S11, 5, 3, bw=100, delay='60ms', loss=0)
		self.addLink(H1, S1, 1, 5, bw=1000, delay='1ms', loss=0)
		self.addLink(S12, H2, 5, 1, bw=1000, delay='1ms', loss=0)
		self.addLink(S2, S10, 3, 6, bw=100, delay='40ms', loss=0)
		self.addLink(S7, S9, 3, 6, bw=100, delay='40ms', loss=0)
		self.addLink(S3, H3, 4, 1, bw=1000, delay='1ms', loss=0)
		self.addLink(S6, H4, 4, 1, bw=1000, delay='1ms', loss=0)
		self.addLink(S1, S10, 6, 7, bw=100, delay='10ms', loss=0)
		self.addLink(S9, S12, 7, 6, bw=100, delay='90ms', loss=0)
