...
class MyTopo(Topo):
	def build(self, **param):
		...
		self.addLink(S3, S4, 2, 1, bw=100, delay='60ms', loss=0)
		self.addLink(S4, S10, 2, 1, bw=100, delay='60ms', loss=0)
		self.addLink(S1, S5, 3, 1, bw=100, delay='40ms', loss=0)
		self.addLink(S5, S6, 2, 1, bw=100, delay='90ms', loss=0)
		self.addLink(S6, S7, 2, 1, bw=100, delay='80ms', loss=0)
		self.addLink(S7, S10, 2, 2, bw=100, delay='50ms', loss=0)
		self.addLink(S10, H2, 3, 1, bw=1000, delay='1ms', loss=0)
		self.addLink(S1, S8, 4, 1, bw=100, delay='70ms', loss=0)
		self.addLink(S8, S3, 2, 3, bw=100, delay='60ms', loss=0)
		self.addLink(S8, S6, 3, 3, bw=100, delay='50ms', loss=0)
		self.addLink(S6, S9, 4, 1, bw=100, delay='80ms', loss=0)
		self.addLink(S9, S3, 2, 4, bw=100, delay='10ms', loss=0)
		self.addLink(S9, S10, 3, 4, bw=100, delay='30ms', loss=0)
